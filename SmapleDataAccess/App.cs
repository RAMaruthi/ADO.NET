...
namespace SampleDataAccessApp.Practical
{
    ...
    namespace Dalayer
    {
        ...
        class DataComponent : IDataAccessComponent
        {
            ...
            const string STRINSERT = "insterEmp";
            const string STRUPDATE = "Update Emp Set EmpName = @empName, EmpAddress = @empAddress, EmpSalary = @empSalary WHERE EmpId = @empId";
            const string STRALL = "SELECT * FROM Emp";
            const string STRALLDEPTS = "SELECT * FROM TBLDEP";
            const string STRDELETE = "DELETE FROM Emp WHERE EMPID = @id";
            #endregion
            ...
            public void AddNewEmployee(Employee emp)
            {
                ...
                parameters.Add(new SqlParameter("@empAdd", emp.EmpAddress));
                parameters.Add(new SqlParameter("@empSalary", emp.EmpSalary));
                parameters.Add(new SqlParameter("@depId", emp.DeptId));
